...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", training=False, **kwargs):
    ...
    if 'llava' in model_name.lower():
        ...
        if model.config.mm_video_tower is not None:
            ...
            if not video_tower.is_loaded:
                video_tower.load_model(training=training)
