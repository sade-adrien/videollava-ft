...
class DataArguments:
    ...
    ############################################################
    data_eval_path: Optional[List[str]] = field(default=None, metadata={"help": "Path to the evaluation data."})
    ############################################################
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        try:
            ...
            if 'image' in sources[0] and 'video' not in sources[0]:
                ...
                image = [video_processor(v, return_tensors='pt', segments=self.list_data_dict[i]['segments'])['pixel_values'][0] for v in video]  # fake image
